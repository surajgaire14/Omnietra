...
const exoloadPlanets = () => {
    const exoplanets = [
        { name: 'Proxima Centauri b', actualDistance: 40.0, scaledDistance: 53.2, comparison: '1.17 lk', img: 'assets/Proxima_Centauri_b.png', distance: 0.0532 },
        { name: 'TRAPPIST-1d', actualDistance: 374.2, scaledDistance: 497.1, comparison: '1.07 lk', img: 'assets/kepler.png', distance: 0.4971 },
        { name: 'LHS 1140 b', actualDistance: 378.1, scaledDistance: 502.5, comparison: '1.45 lk', img: 'assets/kepler.png', distance: 0.5025 },
        { name: 'K2-18 b', actualDistance: 1173.3, scaledDistance: 1564.3, comparison: '1.2 lk', img: 'assets/kepler.png', distance: 1.5643 },
        { name: 'TOI 700 d', actualDistance: 946.0, scaledDistance: 1257.0, comparison: '1.25 lk', img: 'assets/kepler.png', distance: 1.2570 },
        { name: 'HD 40307 g', actualDistance: 396.2, scaledDistance: 526.8, comparison: '1.25 lk', img: 'assets/kepler.png', distance: 0.5268 },
        { name: 'Kepler-186f', actualDistance: 5490.5, scaledDistance: 7310.1, comparison: '1.1 lk', img: 'assets/kepler.png', distance: 7.3101 },
        { name: 'GJ 357 d', actualDistance: 292.5, scaledDistance: 389.5, comparison: '1.3 lk', img: 'assets/kepler.png', distance: 0.3895 },
        { name: 'HD 209458 b', actualDistance: 70.8, scaledDistance: 94.2, comparison: '1.38 lk', img: 'assets/kepler.png', distance: 0.0942 },
        { name: 'WASP-121 b', actualDistance: 8015.7, scaledDistance: 10645.1, comparison: '1.8 lk', img: 'assets/kepler.png', distance: 10.6451 }
    ];
    ...
    exoplanets.forEach(exoplanet => {
        ...
        // Add a click event to show planet info in the sliding panel
        exoplanetMarkerInstance.on('click', () => {
            // Update the planet info content and open the sliding panel
            const infoContent = `
                <strong>${exoplanet.name}</strong><br>
...
// Add a function to close the sliding panel when clicking outside
